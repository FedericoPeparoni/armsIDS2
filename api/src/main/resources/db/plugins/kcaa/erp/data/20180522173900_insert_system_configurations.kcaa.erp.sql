...
begin
    ...
    execute format(v_query) using 'KCAA ERP Database Connection URL', system_item_type_id('kcaa erp'), system_data_type_id('string'), null, null, 'jdbc:sqlserver://localhost:1433;databaseName=erp;', null, 'system', true, 'CONNECTION_URL';
