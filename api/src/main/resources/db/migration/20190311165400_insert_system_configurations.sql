...
begin
    ...
    EXECUTE format(v_query) USING 'Extended hours surcharge basis', system_item_type_id('ansp'), system_data_type_id('string'), null, 'fixed,per hour', 'fixed', 'fixed', 'system';
