...
-- use double precision with actualMtow to avoid rounding errors
alter table flight_movements alter column actual_mtow type double precision;

-- recreate charge view with new column type
