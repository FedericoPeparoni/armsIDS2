...
begin
    ...
    execute format(v_query) using 'Mark zero flight costs as paid', system_item_type_id('workflow'), system_data_type_id('string'), null,
    'Manually,After 30 days,As invoiced', 'After 30 days', 'After 30 days', 'system';
