ALTER TABLE exempt_aircraft_flights

    ALTER COLUMN enroute_fees_exempt DROP DEFAULT,
    ALTER COLUMN enroute_fees_exempt TYPE double precision USING (CASE WHEN enroute_fees_exempt IS TRUE THEN 100 ELSE 0 END),
    ...
    ALTER COLUMN parking_fees_exempt DROP DEFAULT,
    ALTER COLUMN parking_fees_exempt TYPE double precision USING (CASE WHEN parking_fees_exempt IS TRUE THEN 100 ELSE 0 END),
