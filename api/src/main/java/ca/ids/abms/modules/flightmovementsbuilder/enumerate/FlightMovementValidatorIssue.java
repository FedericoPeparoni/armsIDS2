...
public enum FlightMovementValidatorIssue {
	...
	UNIFIED_TAX_NOT_PAID_FOR_CURRENT_YEAR("UNIFIED_TAX_NOT_PAID_FOR_CURRENT_YEAR");
    ...
    static {
        ...
        values.put("UNIFIED_TAX_NOT_PAID_FOR_CURRENT_YEAR",UNIFIED_TAX_NOT_PAID_FOR_CURRENT_YEAR);        
    }
