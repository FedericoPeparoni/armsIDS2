...
public class CreditPaymentTransactionException extends RuntimeException {
    /**
     ...
     * @since  1.4
     */
    CreditPaymentTransactionException(final ErrorConstants reason, final Throwable cause) {
        super(cause);
        this.reason = reason;
    }
