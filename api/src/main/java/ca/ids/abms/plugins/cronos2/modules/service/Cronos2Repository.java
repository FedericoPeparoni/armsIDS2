...
import ca.ids.abms.plugins.cronos2.config.Cronos2DatabaseConfig;
...
@Repository
public class Cronos2Repository {
    ...
    public Cronos2Repository(
        @Value("${app.cronos2.fplImport.bufferCapacity}") final int bufferCapacity,
        @Qualifier(Cronos2DatabaseConfig.NAMED_PARAMETER_JDBC_TEMPLATE) final NamedParameterJdbcTemplate namedParameterJdbcTemplate
    ) {
