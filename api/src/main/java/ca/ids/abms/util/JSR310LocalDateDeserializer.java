...
public class JSR310LocalDateDeserializer extends JsonDeserializer<LocalDate> {
    ...
    public LocalDate deserialize(JsonParser parser, DeserializationContext context) throws IOException {
        ...
        case START_ARRAY:
            ...
            if(parser.nextToken() != JsonToken.END_ARRAY) {
                throw context.wrongTokenException(parser, JsonToken.END_ARRAY, Translation.getLangByToken("Expected array to end."));
            }
        ...
        default:
            throw context.wrongTokenException(parser, JsonToken.START_ARRAY, Translation.getLangByToken("Expected array or string."));
        }
    }
}
