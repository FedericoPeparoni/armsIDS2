...
import { TuRateManagementService } from './partials/tu-rate-management/service/tu-rate-management.service';
...
export default angular.module('armsWeb.services', [])
  ...
  .service('tuRateManagementService', TuRateManagementService);
