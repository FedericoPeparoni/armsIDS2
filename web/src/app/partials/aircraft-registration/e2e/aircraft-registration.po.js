...
let aircraftRegistrationManagement = function () {

  this.page = element(by.css('div[ng-class="main.aircraft-registration"]'));
...
module.exports = new aircraftRegistrationManagement();
