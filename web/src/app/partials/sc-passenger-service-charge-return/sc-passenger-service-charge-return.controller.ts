// interfaces
import { IPassengerServiceChargeReturnScope, IPassengerServiceChargeReturn } from './sc-passenger-service-charge-return.interface';
...
// services
import { ScPassengerServiceChargeReturnService } from './service/sc-passenger-service-charge-return.service';
...
export class ScPassengerServiceChargeReturnController extends CRUDFileUploadController {

  /* @ngInject */
  constructor(protected $scope: IPassengerServiceChargeReturnScope, private scPassengerServiceChargeReturnService: ScPassengerServiceChargeReturnService,
    protected $uibModal: ng.ui.bootstrap.IModalService, private saveLocalTemplateService: SaveLocalTemplateService,
    private systemConfigurationService: SystemConfigurationService) {
    super($scope, scPassengerServiceChargeReturnService, $uibModal, 'File Name');
    super.setup();
