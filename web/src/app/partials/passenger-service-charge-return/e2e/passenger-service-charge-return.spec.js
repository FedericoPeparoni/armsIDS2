...
describe('passenger-service-charge-return view', () => {
    var page;
    var helpers;
    ...
    beforeEach(() => {
        browser.get('/#/passenger-service-charge-return');
        page = require('./passenger-service-charge-return.po');
        mock(['passenger-service-charge-return/e2e/passenger-service-charge-return.mock']);
