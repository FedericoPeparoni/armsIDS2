...
let RepositioningAerodromeClusters = function() {

    this.page = element(by.css('div[ng-class="main.repositioning-aerodrome-clusters"]'));
    this.formEl = this.page.element(by.css('form'));

    let fields = [
        'repositioning_aerodrome_cluster_name',
...
module.exports = new RepositioningAerodromeClusters();