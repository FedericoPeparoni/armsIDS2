...
find "$TOP_DIR" -mindepth 1 -maxdepth 1 "(" "(" -path "$TOP_DIR/rpm" -o -name ".*.swp" -o -name ".git*" ")" -prune ")" -o -exec cp -alr '{}' "$RPM_DIR/WORK/tmp/$RPM_NAME-$RPM_VERSION"/ ';'
