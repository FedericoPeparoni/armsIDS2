...
-- drop all views
drop view if exists navdb_common.V_AIRPORT cascade;
drop view if exists navdb_common.V_AIRSPACE cascade;
drop view if exists navdb_common.V_AIRSPACE_ALL cascade;
